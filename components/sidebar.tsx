...
const links = [
  ...
  ["/premium", "Premium Workspace", Sparkles],
...
export default function Sidebar() {
  ...
  return <aside className="fixed inset-y-0 left-0 z-40 w-72 overflow-y-auto bg-slate-950 p-5 text-white">
    ...
    <button onClick={logout} className="fixed bottom-5 left-5 flex w-62 items-center gap-3 rounded-xl bg-slate-950 px-3 py-3 text-slate-300 hover:bg-slate-900"><LogOut size={20}/>Logout</button>
  </aside>;
}
